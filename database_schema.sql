-- ═══════════════════════════════════════════════════════════════
-- KOves — Schema Completo v1.0
-- Copia y pega TODO este archivo en el SQL Editor de Supabase
-- y pulsa "Run". Tardará unos segundos.
-- ═══════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════
-- 3. GROUP_MEMBERS (Miembros del grupo)
-- ══════════════════════════════════════
...
-- ══════════════════════════════════════
-- 4. GROUP_SETTINGS (Reglas del grupo)
-- ══════════════════════════════════════
...
-- ══════════════════════════════════════
-- 5. GROUP_INVITES (Códigos de invitación)
-- ══════════════════════════════════════
...
CREATE POLICY "Creator or admin can update plans" ON public.plans FOR UPDATE USING (
  ...
  EXISTS (
    SELECT 1 FROM public.group_members
    WHERE group_id = plans.group_id AND user_id = auth.uid() AND role = 'admin'
  )
);


-- ══════════════════════════════════════
-- 7. PLAN_ATTENDANCE (Asistencia)
-- ══════════════════════════════════════
...
-- ══════════════════════════════════════
-- 12. EXPENSE_SPLITS (Deudas individuales)
-- ══════════════════════════════════════
...
-- ══════════════════════════════════════
-- 13. SANCTIONS (Tarjetas amarillas/rojas)
-- ══════════════════════════════════════
...
-- ══════════════════════════════════════
-- 14. SANCTION_VOTES (Votación de sanciones)
-- ══════════════════════════════════════
...
-- ══════════════════════════════════════
-- 15. PLAN_RANKINGS (Votación MVP y Tardón)
-- ══════════════════════════════════════
...
CREATE POLICY "Admins can resolve claims" ON public.claims FOR UPDATE USING (
  EXISTS (
    SELECT 1 FROM public.group_members
    WHERE group_id = claims.group_id AND user_id = auth.uid() AND role = 'admin'
  )
);
...
-- ══════════════════════════════════════
-- 20. STORAGE BUCKETS (para fotos y comprobantes)
-- ══════════════════════════════════════
...
-- Vista: Balance de gastos por usuario en un grupo
...
-- ══════════════════════════════════════
-- 22. HABILITAR REALTIME (para chat)
-- ══════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- ✅ ¡SCHEMA COMPLETADO!
-- Las tablas están listas. Las Edge Functions se configuran aparte.
-- ═══════════════════════════════════════════════════════════════
